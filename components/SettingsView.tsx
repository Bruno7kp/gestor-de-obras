        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-medium">O ProMeasure opera em modo "Privacy First". Seus projetos ({projectCount}) ficam protegidos no servidor com controle de acesso por instância.</p>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-medium">A limpeza total de dados agora depende de um fluxo administrativo no servidor.</p>
