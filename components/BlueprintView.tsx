...
export const BlueprintView: React.FC<BlueprintViewProps> = ({ 
  ...
  // --- API sync (debounce accumulator for cell edits) ---
          ...
          <table className="min-w-max w-full border-separate border-spacing-0 text-[13px]">
            <thead className="bg-slate-900 dark:bg-black text-white sticky top-0 z-30">
              <tr className="text-[11px] font-black uppercase tracking-widest opacity-80 text-center">
                ...
                <th className="p-4 border-r border-slate-800 dark:border-slate-900 text-left w-[400px] min-w-[300px] max-w-[400px]">Descrição do Serviço ou Material</th>
