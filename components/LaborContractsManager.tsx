  ...
  const filteredContracts = useMemo(() => {
    ...
    return contracts
      .filter(c => {
        ...
        const matchesPending = !onlyPending || (c.valorTotal - c.valorPago) > 0.01;
        return matchesSearch && matchesType && matchesPending;
      })
      .sort((a, b) => latestPaymentTime(b) - latestPaymentTime(a));
  }, [contracts, workforce, search, filterType, onlyPending]);
