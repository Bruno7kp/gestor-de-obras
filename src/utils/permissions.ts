...
export type PermissionModule = 
  | 'biddings' | 'suppliers' | 'projects_general' | 'projects_specific' | 'wbs' | 'technical_analysis' 
...
export const PERMISSION_MODULES: Array<{ key: PermissionModule; label: string }> = [
  ...
  { key: 'wbs', label: 'Medição' },
  { key: 'technical_analysis', label: 'Análise Técnica' },
  { key: 'financial_flow', label: 'Financeiro' },
  { key: 'supplies', label: 'Compras' },
