...
async function main() {
  ...
  const permissionsList = [
    ...
    { code: 'global_stock_warehouse.view', description: 'View global stock warehouse' },
    { code: 'global_stock_warehouse.edit', description: 'Edit global stock warehouse' },
    { code: 'global_stock_financial.view', description: 'View global stock financial' },
    { code: 'global_stock_financial.edit', description: 'Edit global stock financial' },
